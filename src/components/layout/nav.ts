...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/cultures", labelKey: "nav.cultures", icon: "🌱", allowed: ["admin", "agronomist", "director"] },
  ...
  { href: "/employees", labelKey: "nav.employees", icon: "👥", allowed: ["admin", "agronomist", "director"] },
  { href: "/reports", labelKey: "nav.reports", icon: "📊", allowed: ["admin", "agronomist", "director"] },
  { href: "/notifications", labelKey: "nav.notifications", icon: "🔔", allowed: "any", badge: "notifications" },
  { href: "/ai", labelKey: "nav.ai", icon: "🤖", allowed: ["admin", "agronomist", "director"] },
  { href: "/sensor-entry", labelKey: "nav.sensorEntry", icon: "🧪", allowed: ["admin", "worker"] },
